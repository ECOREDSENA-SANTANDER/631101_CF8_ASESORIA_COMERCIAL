...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    p.mt-5.mb-5.text-center Como actividades de postventa o seguimiento a la venta, Artal (2010) señala:
        ...
        ol.lista-ol--cuadro.lista-ol--separador.fa-ol
          li
            .lista-ol--cuadro__vineta
              span 1
            span.mb-0 La atención en los cobros.
          li
            .lista-ol--cuadro__vineta
              span 2
            span.mb-0 La gestión de impagados.
          li
            .lista-ol--cuadro__vineta
              span 3
            span.mb-0 El cumplimiento correcto de la entrega de pedidos.
          li
    ...
    p.mt-5.mb-5.text-center Según Pérez (2013), las ventajas e inconvenientes del servicio postventa son las siguientes:   
            ...
            .row.justify-content-center.align-items-center(data-aos="fade-right")
              .col-lg-12
                ...
                ol.lista-ol.fa-ol
                  ...
                  li 
                    span.text-bold e. 
                    span.mb-0 #[b Buscar referencias.] Se refiere a personas o empresas que pertenecen a un mismo tipo o clase de organización o asociación. Con la unión a gremios o CC, incluso con clientes que hayan conocido y probado el producto solicitar recomendaciones.
                  li 
                    span.text-bold f. 
                  ...
                  li 
                    span.text-bold h. 
                    span.mb-0 #[b Aprovechar las redes sociales.] Estructuras compuestas por personas en internet. Busca presencia en la web, crea blogs, anuncios en Instagram, Facebook y Twitter.
                  li 
                    span.text-bold i. 
                    span.mb-0 #[b Intercambiar tarjetas de presentación.] Son pequeñas impresiones en papel que da información comercial de una persona o entidad. Aunque un poco obsoleto, pero sigue siendo efectiva, es una manera recordación cuando se presente la necesidad.
            ...
            .row.justify-content-center.align-items-center(data-aos="fade-right")
              .col-lg-12
                ...
                ol.lista-ol.fa-ol
                  ...
                  li 
                    span.text-bold g. 
                    span.mb-0 #[b Crear comunidades virtuales.] Son aquellas personas que se unen a través de internet en grupo con intereses similares. 
                  li 
                    span.text-bold h. 
                    span.mb-0 Crear grupos en Facebook haciendo Lives, Canales en YouTube.
              ...
              tr
                ...
                td.bordeizquierdoabajo 
                  ul.lista-ul--color.fa-al
                    ...
                    li.mb-0 
                      i.fas.fa-check-circle
                      span.mb-0 Tasa de fallos (Caos no solucionados).
                    li.mb-0 
                      i.fas.fa-check-circle
                      span.mb-0 Indicadores financieros.
              tr
              ...
              tr
                ...
                td.bordeizquierdoabajo
                  ul.lista-ul--color.fa-al
                    ...
                    li.mb-0 
                      i.fas.fa-check-circle
                      span.mb-0 Reclamaciones originadas por desconocimiento del cliente.
    ...
    p.mb-4 En esta etapa de la postventa la empresa llevará a cabo lo planificado, para a esto tendrá en cuenta de acuerdo con Pérez (2013):
    ...
    .row(data-aos="zoom-in")
      p.mb-4.mt-2 Una manera de controlar las actividades de postventa incluyendo el resultado final, es según Pérez (2013):
      ol.lista-ol--cuadro.lista-ol--separador.fa-ol
        li
          .lista-ol--cuadro__vineta
            span 1
          span.mb-0 En la planificación, es fundamental seguir de cerca los indicadores propuestos. Es necesario verificar que los resultados coincidan con los indicadores establecidos y, en función de estos resultados, tomar las acciones adecuadas para implementar mejoras.
        li
          .lista-ol--cuadro__vineta
            span 2
          span.mb-0 Registrar el procedimiento en una lista de chequeo que lo pueda comprar a como se registra el protocolo. 
        li
          .lista-ol--cuadro__vineta
            span 3
          span.mb-0 Registrar medidas tomadas.
        li
          .lista-ol--cuadro__vineta
            span 3
          span.mb-0 Corregir lo que no esté según los procedimientos de la empresa.
        li
    ...
    .row
      ...
      p.mb-5 #[b Entonces, ¿cómo estructurar un servicio postventa? Según Pérez (2013), se deben considerar tanto la estructura como las funciones del servicio, tal como se detalla a continuación:]
